class AVLTreeMap(TreeMap):
    ...
    class _Node(TreeMap._Node):
        """Node class for AVL tree maintains height value for balancing"""
        ...
        def left_height(self):
            return self._left._height if self._left in not None else 0
    ...
    def _rebalance(self, p):
        while p is not None:
            ...
            if not self._isbalanced(p):         #imbalance detected
                #perform trinode restructing, setting p to resulting root
                #and recompute new local heights after the resctructing
